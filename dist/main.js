...
System.register("class/Marker", [], function (exports_3, context_3) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            Marker = class Marker {
                constructor(map, position, store, description, vendeur) {
            ...
            exports_3("Marker", Marker);
        }
    };
});
System.register("class/App", ["class/Point", "class/Marker", "class/Vendeur"], function (exports_4, context_4) {
    "use strict";
    var __moduleName = context_4 && context_4.id;
    var Point_1, Marker_1, Vendeur_1, STORAGE_KEY, App;
    return {
        setters: [
            function (Point_1_1) {
                Point_1 = Point_1_1;
        ...
        execute: function () {
            ...
            App = class App {
                constructor() {
                    ...
                    this.vendeur = document.getElementById("vendeur");
                    this.form_vend = document.getElementById("form-vend");
                    this.mag = document.getElementById("liste");
                    this.name = document.getElementById("name_vendeur");
                    this.firstname = document.getElementById("firstname_vendeur");
                ...
                addMarker() {
                    ...
                    this.marker = new Marker_1.Marker(this.getMap(), this.position, this.getStore().value, this.getDescription().value, this.vendeurs);
                    this.markers.push(this.marker);
                }
                updateMarker(mag, vendeur) {
                ...
                showStores() {
                    ...
                    if (array != null) {
                        for (let mark of array) {
                            const marker = new Marker_1.Marker(this.map, new Point_1.Point(mark.position.lat, mark.position.lng), mark.store, mark.description, mark.vendeur);
...
System.register("main", ["class/App"], function (exports_5, context_5) {
    "use strict";
...
System.register("class/Product", [], function (exports_6, context_6) {
    "use strict";
